					...
					filter: {
						...
						condition: function (datum) {
							...
							var conditions = [
								...
								(datum.main.toLowerCase().indexOf(base.data.query.toLowerCase().trim()) === 0 || ((base.data.autocompleteOverride || false) && base.data.query === '')), // lower case query match at beginning
