# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-19 12:05
from __future__ import unicode_literals

import apps.tr.models.client.project
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('file', models.FileField(upload_to=apps.tr.models.client.project.rename_export_file)),
                ('is_forced', models.BooleanField(default=False)),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exports', to='tr.Batch')),
            ],
        ),
        migrations.CreateModel(
            name='Flag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.TextField(default='')),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderations', to='tr.Batch')),
            ],
        ),
        migrations.CreateModel(
