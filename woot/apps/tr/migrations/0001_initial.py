# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-09-24 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transcriptions', to='tr.Caption')),
        ...
        migrations.AddField(
            model_name='caption',
            name='grammar',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='captions', to='tr.Grammar'),
        ),
        migrations.AddField(
            model_name='caption',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='captions', to='tr.Project'),
        ),
        migrations.AddField(
            model_name='batch',
            name='project',
